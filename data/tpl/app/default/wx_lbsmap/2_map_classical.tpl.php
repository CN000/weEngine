...
<head>
	...
	<script type="text/javascript">//弹出垂直菜单</script>
...
function addMapOverlay() {
    ...
    for (var index = 0; index < markers.length; index++) {
        ...
        // 图片上的名字 调整位置offset: new BMap.Size(-40, -30)}  修改这里面的参数就好
        var label = new BMap.Label(markers[index].sname + "， 距离您" + markers[index].dist, {offset: new BMap.Size(-40, -30)});
