window.TILE_VERSION = {
    "ditu": {
        "normal": {"version": "088", "updateDate": "20171228"},
        "satellite": {"version": "009", "updateDate": "20171228"},
        "normalTraffic": {"version": "081", "updateDate": "20171228"},
        "satelliteTraffic": {"version": "083", "updateDate": "20171228"},
        "mapJS": {"version": "104", "updateDate": "20171228"},
        "satelliteStreet": {"version": "083", "updateDate": "20171228"},
        "panoClick": {"version": "1033", "updateDate": "20171225"},
        "panoUdt": {"version": "20171225", "updateDate": "20171225"},
        "panoSwfAPI": {"version": "20150123", "updateDate": "20150123"},
        "panoSwfPlace": {"version": "20141112", "updateDate": "20141112"},
        "earthVector": {"version": "001", "updateDate": "20171228"}
    },
    "webapp": {
        "high_normal": {"version": "001", "updateDate": "20171228"},
        "lower_normal": {"version": "002", "updateDate": "20171228"}
    },
    "api_for_mobile": {
        "vector": {"version": "002", "updateDate": "20171228"},
        "vectorIcon": {"version": "002", "updateDate": "20171228"}
    }
};
...
(function () {
    ...
    window._addStat = function (aX, aW) {
        ...
        var aY = function (i) {
            ...
            setTimeout(function () {
                _addStat._img.src = "https://api.map.baidu.com/images/blank.gif?" + i.src
            }, 50)
        };
        var e = function () {
    ...
    var aJ = {
        ...
        B_DIMENSIONAL_MAP: {
            tileUrls: ["https://d0.map.baidu.com/resource/mappic/", "https://d1.map.baidu.com/resource/mappic/", "https://d2.map.baidu.com/resource/mappic/", "https://d3.map.baidu.com/resource/mappic/"],
            tileSize: 256,
            baseUnits: 256,
            zoomLevelMin: 15,
            zoomLevelMax: 20,
            ...
            bounds: new y(-21364736, -10616832, 23855104, 15859712),
            imgExtend: "jpg",
            hotspotUrl: ["https://d0.map.baidu.com/resource/js/map/", "https://d1.map.baidu.com/resource/js/map/", "https://d2.map.baidu.com/resource/js/map/", "https://d3.map.baidu.com/resource/js/map/"],
            entityUrl: "https://d0.map.baidu.com/resource/js/entity/",
            citys: {
    ...
    l.extend(aq, {
        ...
        preLoaded: {},
        Config: {_baseUrl: "https://api.map.baidu.com/getmodules?v=1.1", _timeout: 5000},
        delayFlag: false,
    ...
    BMap.register(function (e) {
        ...
        e.addEventListener("load", function () {
            ...
            if (e.getMapType() == BMAP_PERSPECTIVE_MAP) {
                aT = '<span style="color:#fff">&copy; 2013 Baidu - Data &copy; </span><a href="https://o.cn" target="_blank" style="color:#fff">\u90fd\u5e02\u5708</a>'
            }
            ...
            e.addEventListener("maptypechange", function () {
                ...
                if (aV == BMAP_PERSPECTIVE_MAP) {
                    aU.addCopyright({
                        id: 1,
                        content: '<span style="color:#fff;text-shadow:0 1px 3px black">&copy; 2013 Baidu - Data &copy; </span><a href="https://o.cn" target="_blank" style="color:#fff;text-shadow:0 1px 3px black">\u90fd\u5e02\u5708</a>'
                    })
                }
...
(function () {
    ...
    var TrafficControl = function (opts) {
        ...
        BMap.MapType.B_LiveTraffic_MAP = {
            tileUrls: ["https://wp0.map.baidu.com/traffic/", "https://wp1.map.baidu.com/traffic/", "https://wp2.map.baidu.com/traffic/", "https://wp3.map.baidu.com/traffic/"],
            tileSize: 256,
            baseUnits: 256,
            zoomLevelMin: 1,
            zoomLevelMax: 18,
