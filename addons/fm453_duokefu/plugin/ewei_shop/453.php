...
$fanid = $_GPC['fanid'];
	...
	$filename = $_W['siteroot']."app/".str_replace('./','',url('entry//ordersactions',array('op'=>'orderlist','m'=>'fm453_kfzs_eweishop','openid'=>$openid,'fanid'=>$fanid,'page'=>$_GPC['page'])));
	load()->func('communication');
	$returns = ihttp_get($filename);//将数据存入数组
	//print_r($returns['content']);
	$return['ewei_shop'] = $returns['content'];