 ...
 * 修复/更新数据库（此选项仅能用在升级程序时，其他情况下不要使用）
 */
 defined('IN_IA') or exit('Access Denied');
 $sql ="";
 $sql .="DROP TABLE IF EXISTS ". tablename('fm453_duokefu_fanslistkey').";";
 $sql .="CREATE TABLE". tablename('fm453_duokefu_fanslistkey')." (
